                                        ...
                                        $menu =   wp_nav_menu(
                                            array(
                                                ...
                                                'items_wrap' => '<ul class="nav navbar-nav">%3$s</ul>',
                                                      'before' => '<li class="active dropdown yamm-fw"> <a data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">',
       'after' => '</a></li>',

           //  'link_before' => '<a    data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown" span class="menu-label hot-menu hidden-xs">',
       //'link_after' => '</span></a>',
            ...
            'walker'          => new WP_Bootstrap_Navwalker(),
                                    ...
                                    ?> 
                                     ...
                                     wp_nav_menu(
                                            array(
                                                'theme_location' => 'main_menu1',
                                             
                                                'items_wrap' => '<ul class="links">%3$s ' . $menu . '</ul>'
                                            )
                                        );
                                    ?> 
