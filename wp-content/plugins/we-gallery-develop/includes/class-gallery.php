 ...
 *
 * @author Tareq Hasan <tareq@wtdevs.com>
 */
class Wt_Gallery_Gallery {
    ...
    public function get_image_ids() {
        $image_ids = get_post_meta( $this->ID, wtgal_get_meta_key(), true );
    ...
    public function get_image( $attachment_id, $context = 'grid' ) {
        ...
        if ( $context == 'slider' ) {
            $image_data['sizes']['slider'] = wp_get_attachment_image( $attachment_id, 'wtslider-slide-image' );
        }

        return apply_filters( 'wtgal_get_image', $image_data, $attachment_id, $this->ID, $this->post );
    }
    ...
    public function get_images( $context = 'grid' ) {
        ...
        return apply_filters( 'wtgal_get_images', $image_array, $image_ids, $this->ID, $this->post );
    }
}