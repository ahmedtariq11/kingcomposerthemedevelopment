...
$woocommerce = new Client(
    'http://localhost/wocommerceevegetables', // Your store URL
    'ck_11186f896098d85977d39d9e0d1da3c46d90dbbe', // Your consumer key
    'cs_bcd112003bf2b03c592172e8233f6008687340b1', // Your consumer secret
    [
...
if (isset($_POST['btn-update'])) {
	...
	header('Location: http://localhost/wocommerceevegetables/woo');
}
...
if(isset($result)) {
                                ...
                                <div class="col-xs-6 col-sm-3 placeholder">
                                    <p id="large">
                                           <?php  
if(isset($customer)) { echo $customer?>
          <?php 
                                   }
                                   ?>
                                    </p>
