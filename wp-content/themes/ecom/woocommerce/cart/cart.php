...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="table" cellspacing="0">
		<thead>
			<tr>
				<th class="product-remove cart-romove item">Remove</th>
				<th class="product-thumbnail cart-description item">Image</th>
				<th class="product-name cart-product-name item"><?php esc_html_e( 'Product Name', 'woocommerce' ); ?></th>
				<th class="product-price"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
				<th class="product-quantity cart-qty item"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
				<th class="product-subtotal cart-total last-item"><?php esc_html_e( 'Grandtotal', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="form-group">
                                        	<input type="text" name="coupon_code" class="form-control unicase-form-control text-input" placeholder="You Coupon.."  id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> 
                                        </div>
